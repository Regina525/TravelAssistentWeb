...
function Header() {
  ...
  return (
    <div className="absolute top-10 z-50 my-auto flex w-full justify-between self-center bg-blue px-7 py-4 text-lg text-white">
      <Link href="/">
      ...
      <div className="text-md flex gap-4">
        <div className="flex gap-4 py-2">
          {user &&(<span onClick={handleLogout} className=' cursor-pointer'>Sair</span>)}
        </div>
       {!user && (<Link to="/login">   <RegisterButton /></Link>)}
